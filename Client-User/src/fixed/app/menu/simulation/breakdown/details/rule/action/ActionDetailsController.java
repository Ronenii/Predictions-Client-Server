package fixed.app.menu.simulation.breakdown.details.rule.action;
...
import fixed.app.menu.simulation.breakdown.details.rule.action.calculation.CalculationDetailsController;
import fixed.app.menu.simulation.breakdown.details.rule.action.condition.MultipleConditionDetailsController;
import fixed.app.menu.simulation.breakdown.details.rule.action.condition.SingleConditionDetailsController;
import fixed.app.menu.simulation.breakdown.details.rule.action.increase.decrease.IncreaseOrDecreaseDetailsController;
import fixed.app.menu.simulation.breakdown.details.rule.action.proximity.ProximityDetailsController;
import fixed.app.menu.simulation.breakdown.details.rule.action.replace.ReplaceDetailsController;
import fixed.app.menu.simulation.breakdown.details.rule.action.set.SetDetailsController;
