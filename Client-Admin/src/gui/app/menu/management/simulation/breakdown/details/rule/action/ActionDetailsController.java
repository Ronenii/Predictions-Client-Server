...
import gui.app.menu.management.simulation.breakdown.details.rule.action.calculation.CalculationDetailsController;
import gui.app.menu.management.simulation.breakdown.details.rule.action.condition.MultipleConditionDetailsController;
import gui.app.menu.management.simulation.breakdown.details.rule.action.condition.SingleConditionDetailsController;
import gui.app.menu.management.simulation.breakdown.details.rule.action.increase.decrease.IncreaseOrDecreaseDetailsController;
import gui.app.menu.management.simulation.breakdown.details.rule.action.proximity.ProximityDetailsController;
import gui.app.menu.management.simulation.breakdown.details.rule.action.replace.ReplaceDetailsController;
import gui.app.menu.management.simulation.breakdown.details.rule.action.set.SetDetailsController;
